...
public class ModEntityType<T extends Entity> extends EntityType<T> {
    ...
    public static final EntityType<Pinky> PINKY = register(-4, "pinky", EntityType.Builder.of(Pinky::new, MobCategory.MONSTER).sized((1.2f) * (2f/3f), (0.75f) * (2f/3f)).eyeHeight(1).clientTrackingRange(1000));
    public static final EntityType<GreenSlime> GREEN_SLIME = register(-3, "green_slime", EntityType.Builder.of(GreenSlime::new, MobCategory.MONSTER).sized((1.8f) * (2f/3f), (1.125f) * (2f/3f)).eyeHeight(1).clientTrackingRange(1000));

    public static final EntityType<BlueSlime> BLUE_SLIME = register(1, "blue_slime", EntityType.Builder.of(BlueSlime::new, MobCategory.MONSTER).sized((2) * (2f/3f), (1.25F) * (2f/3f)).eyeHeight(1).clientTrackingRange(1000));

    public static final EntityType<AngryBones> ANGRY_BONES = register(31, "angry_bones", EntityType.Builder.of(AngryBones::new, MobCategory.MONSTER).sized((2.1333334f) * (2f/3f), (2.5833333f) * (2f/3f)).eyeHeight(1).clientTrackingRange(1000));

    public static final EntityType<DungeonSlime> DUNGEON_SLIME = register(71, "dungeon_slime", EntityType.Builder.of(DungeonSlime::new, MobCategory.MONSTER).sized((2.75f) * (2f/3f), (1.71875f) * (2f/3f)).eyeHeight(1).clientTrackingRange(1000));
