...
public class CopperWatchRenderer implements TrinketRenderer {
    public HumanoidModel<LivingEntity> model = new WatchModel(WatchModel.createBodyLayer().bakeRoot());
    public ResourceLocation texture = ResourceLocationHelper.parse("textures/models/accessories/copper_watch");
    @Override
