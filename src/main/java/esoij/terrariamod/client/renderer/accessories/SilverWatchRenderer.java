...
public class SilverWatchRenderer implements TrinketRenderer {
    public HumanoidModel<LivingEntity> model = new WatchModel(WatchModel.createBodyLayer().bakeRoot());
    public ResourceLocation texture = ResourceLocationHelper.parse("textures/models/accessories/silver_watch");
    @Override
